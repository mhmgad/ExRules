...
gnuplot -e "dataFile='$SUMMARY_FILE_POS'; outputPlot='$SUMMARY_PLOT_POS'" plot_conflict.gp
gnuplot -e "dataFile='$SUMMARY_FILE_NEG'; outputPlot='$SUMMARY_PLOT_NEG'" plot_conflict.gp
